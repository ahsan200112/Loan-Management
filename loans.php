			...
			<table class="table table-bordered" id="loan-list">
				...
				<tbody>
					<?php
						...
						$qry = $conn->query("SELECT l.*,concat(b.firstname,' ',b.lastname)as name, b.contact_no, b.email, b.address, b.TAXID from loan_list l inner join borrowers b on b.id = l.borrower_id  order by id asc");
						...
						<td>
							...
							<p><small>TAX ID: <b><?php echo $row['TAXID'] ?></small></b></p>
